...
| [0005](0005-rg-enforcement-point.md) | RG & eligibility enforcement | Two-point filtering: eligibility pre-filter at build + fail-closed compliance gate at serve; every suppression logged with rule ID | Filtering stage |
